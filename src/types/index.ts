...
// Matches all genre-like fields from an anime (genres + themes + demographics)
...
export const ALL_TIERS: AllTiers[] = ['S', 'A', 'B', 'C', 'D', 'F', 'unranked']

export const TIER_COLORS: Record<AllTiers, string> = {
  S: '#ff5757', A: '#ffbe4f', B: '#4fbdff',
  C: '#4fdb8e', D: '#c084fc', F: '#6b7280', unranked: '#3a3a52',
}

// Correct Jikan v4 genre IDs — genres + themes + demographics
...
export const DEFAULT_FILTERS: FilterState = {
  genres: [], types: [], ratings: [], statuses: [], years: [],
  userList: 'all', query: '',
}
